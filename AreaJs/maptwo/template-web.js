/*! art-template@4.1.0 | https://github.com/aui/art-template */ ! function(e, t) { "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define([], t) : "object" == typeof exports ? exports.template = t() : e.template = t() }(this, function() {
    return function(e) {
        function t(r) { if (n[r]) return n[r].exports; var o = n[r] = { i: r, l: !1, exports: {} }; return e[r].call(o.exports, o, o.exports, t), o.l = !0, o.exports }
        var n = {};
        return t.m = e, t.c = n, t.i = function(e) { return e }, t.d = function(e, n, r) { t.o(e, n) || Object.defineProperty(e, n, { configurable: !1, enumerable: !0, get: r }) }, t.n = function(e) { var n = e && e.__esModule ? function() { return e.default } : function() { return e }; return t.d(n, "a", n), n }, t.o = function(e, t) { return Object.prototype.hasOwnProperty.call(e, t) }, t.p = "", t(t.s = 20)
    }([function(e, t, n) {
        "use strict";
        var r = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) { return typeof e } : function(e) { return e && "function" == typeof Symbol && e.constructor === Symbol && e !== Symbol.prototype ? "symbol" : typeof e },
            ...
            u = function e(t) {
                ...
                var u = n.debuger,
                    ...
                    s = n.cache,
                    a = n.caches;
                if (s && c) { var l = a.get(c); if (l) return l }
                if (!t) { var f = n.resolveFilename(c, n); try { t = n.loader(f), n.filename = f, n.source = t } catch (e) { var p = { path: c, name: "CompileError", message: "template not found: " + e.message, stack: e.stack }; if (n.bail) throw p; return u(p) } }
                var y = new o(n),
                    h = function t(r, o) { try { return t.source(r, o) } catch (t) { if (!n.compileDebug) return n.cache = !1, n.compileDebug = !0, e(n)(r, o); if (n.bail) throw t; return u(t)() } };
                try { h.source = y.build(), s && c && a.set(c, h) } catch (e) { if (n.bail) throw e; return u(e) }
                return h.toString = function() { return h.source.toString() }, h
            };
        e.exports = u
    }, function(e, t, n) {
        "use strict";
        var r = n(9),
            ...
            l = n(15),
            f = n(14),
            p = { source: null, filename: null, rules: [a, l], escape: !0, debug: !1, cache: !0, compileDebug: !1, bail: !1, resolveFilename: f, compressor: null, debuger: r, loader: u, caches: o, root: "/", extname: ".art", imports: { $each: s, $escape: i, $include: c } };
        p.$extend = function(e) { var t = Object.create(this); for (var n in e) t[n] = e[n]; return t }, e.exports = p
    }, function(e, t, n) {
        "use strict";
        ...
        "use strict";
        (function(t) { e.exports = !1; try { e.exports = "[object process]" === Object.prototype.toString.call(t.process) } catch (e) {} }).call(t, n(7))
    }, function(e, t, n) {
        "use strict";
        ...
        "use strict";
        var r = function(e) { var t = { "<": "&#60;", ">": "&#62;", '"': "&#34;", "'": "&#39;", "&": "&#38;" }; return function e(t) { return "string" != typeof t && (t = "function" == typeof t ? e(t.call(t)) : null === t ? "" : JSON.stringify(t) || ""), t }(e).replace(/&(?![\w#]+;)|[<>"']/g, function(e) { return t[e] }) };
        e.exports = r
    }, function(e, t, n) {
        "use strict";
        var r = function(e, t, r, o) { var i = n(0); return o = o.$extend({ filename: o.resolveFilename(e, o), source: null }), i(o)(t, r) };
        e.exports = r
    }, function(e, t, n) {
        "use strict";
        var r = n(4),
        ...
        var r = {
                ...
                use: function(e, t, n, r) {
                    var i = this,
                        ...
                        s = c.map(function(e) { return e.value }),
                        a = {},
                        l = void 0,
                        f = !!t && "raw",
                        p = n + s.shift(),
                        y = function(e, t) { console.warn("Template upgrade:", "{{" + e + "}}", ">>>", "{{" + t + "}}", "\n", u.filename || "") };
                    switch ("#" === t && y("#value", "@value"), p) {
                        ...
                        default:
                            if (-1 !== s.indexOf("|")) {
                                for (var b = p, $ = [], g = s.filter(function(e) { return !/^\s+$/.test(e) });
                                    "|" !== g[0];) b += g.shift();
                                g.filter(function(e) { return ":" !== e }).forEach(function(e) { "|" === e ? $.push([]) : $[$.length - 1].push(e) }), $.reduce(function(e, t) { var n = t.shift(); return t.unshift(e), r = n + "(" + t.join(",") + ")" }, b)
            ...
            o = function(e) {
                ...
                return r.map(function(e) { return e.map(function(e) { return e.value }).join("") })
            };
        r._split = o, e.exports = r
    }, function(e, t, n) {
        "use strict";
        var r = { test: /<%(#?)((?:==|=#|[=-])?)([\w\W]*?)(-?)%>/, use: function(e, t, n, r) { var o = { "-": "raw", "=": "escape", "": !1, "==": "raw", "=#": "raw" }; return t && (r = "//" + r), { code: r, output: o[n] } } };
        e.exports = r
    }, function(e, t, n) {
        "use strict";
                ...
                return u(e, [{ key: "getTplTokens", value: function() { return s.apply(void 0, arguments) } }, { key: "getEsTokens", value: function(e) { return c(e) } }, { key: "getVariables", value: function(e) { var t = !1; return e.filter(function(e) { return "whitespace" !== e.type && "comment" !== e.type }).filter(function(e) { return "name" === e.type && !t || (t = "punctuator" === e.type && "." === e.value, !1) }).map(function(e) { return e.value }) } }, {
                    ...
                    value: function(e) {
                        var t = this,
                            ...
                            s = c.imports,
                            p = this.CONTEXT_MAP;
                        y(p, e) || y(i, e) || a(e) || (y(r, e) ? (n = r[e], y(o, e) && o[e].forEach(function(e) { return t.importContext(e) })) : n = y(s, e) ? f + "." + e : l + "." + e, p[e] = n, u.push({ name: e, value: n }))
                    }
                }, {
                    key: "parseString",
                    value: function(e) {
                    ...
                    value: function(e) {
                        ...
                        this.getVariables(p).forEach(function(e) { return t.importContext(e) }), this.scripts.push({ source: n, tplToken: e, code: l })
                    }
                }, {
                    key: "checkExpression",
                    value: function(e) {
                        ...
                        try { return new Function(e), !0 } catch (e) { return !1 }
                    }
                }, {
                    key: "build",
                    value: function() {
                        var e = this.options,
                            ...
                            c = "var " + t.map(function(e) { return e.name + "=" + e.value }).join(","),
                            s = n.map(function(e) { return e.code }).join("\n"),
                        ...
                        d = "function(" + l + "){\n" + d + "\n}";
                        try { return new Function(f, p, "return " + d)(i, e) } catch (e) { for (var v = 0, b = 0, $ = 0, g = r; v < n.length;) { var x = n[v]; if (!this.checkExpression(x.code)) { g = x.source, b = x.tplToken.line, $ = x.tplToken.start; break } v++ } throw { path: o, name: "CompileError", message: e.message, line: b + 1, start: $ + 1, source: g, script: d, stack: e.stack } }
                    }
                }]), e
            }();
        e.exports = d
        ...
        var r = n(5).default,
            o = n(5).matchToToken,
            i = n(2),
            u = function(e) { return e.match(r).map(function(e) { return r.lastIndex = 0, o(r.exec(e)) }).map(function(e) { return "name" === e.type && i(e.value) && (e.type = "keyword"), e }) };
        e.exports = u
    }, function(e, t, n) {
        "use strict";
                ...
                for (var t = e.test.ignoreCase ? "ig" : "g", o = e.test.source + "|^$|[\\w\\W]", i = new RegExp(o, t), u = 0; u < r.length; u++)
                    if ("string" === r[u].type) {
                        for (var c = r[u].line, s = r[u].start, a = r[u].end, l = r[u].value.match(i), f = [], p = 0; p < l.length; p++) {
                            ...
                            if ("string" === d) m && "string" === m.type ? (m.value += y, m.end += y.length) : f.push($);
                            else {
        ...
        var r = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) { return typeof e } : function(e) { return e && "function" == typeof Symbol && e.constructor === Symbol && e !== Symbol.prototype ? "symbol" : typeof e },
            ...
            i = n(0),
            u = n(1),
            c = function(e, t) { return "object" === (void 0 === t ? "undefined" : r(t)) ? o({ filename: e }, t) : i({ filename: e, source: t }) };
